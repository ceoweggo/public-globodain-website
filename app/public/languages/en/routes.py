...
class Skynova:
    ...
    @register_breadcrumb(public_language, '.en_skynova', 'Skynova')
    def skynova():
        return render_template("skynova/es-index.html",
                               lang_data=find_data('skynova_index'))

    @public_language.route("/skynova/solution")
    @register_breadcrumb(public_language, '.en_skynova.solution', 'Solution')
    ...
    @register_breadcrumb(public_language, '.en_skynova.product', 'Product')
    def skynova_product():
        return render_template("skynova/es-product.html",
                               lang_data=find_data('skynova_product'))
    
    @public_language.route("/skynova/models")
    @register_breadcrumb(public_language, '.en_skynova.models', 'Modelos')
    def skynova_models():
